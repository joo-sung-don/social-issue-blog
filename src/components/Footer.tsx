      ...
      <div className="max-w-7xl mx-auto pt-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-1">
            <h4 className="text-gray-900 font-bold text-lg mb-4">Social Issue Blog</h4>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-blue-600">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/contributors" className="text-gray-600 hover:text-blue-600">기고자</Link></li>
              <li><Link href="/archive" className="text-gray-600 hover:text-blue-600">전체 글 보기</Link></li>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2">
              <li><Link href="/terms" className="text-gray-600 hover:text-blue-600">이용약관</Link></li>
              <li><Link href="/privacy" className="text-gray-600 hover:text-blue-600">개인정보처리방침</Link></li>
              <li><Link href="/cookies" className="text-gray-600 hover:text-blue-600">쿠키 정책</Link></li>
              <li><Link href="/guidelines" className="text-gray-600 hover:text-blue-600">커뮤니티 가이드라인</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 py-8">
          <p className="text-center text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} Social Issue Blog. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
